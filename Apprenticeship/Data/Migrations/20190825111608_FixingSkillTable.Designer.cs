...
namespace Apprenticeship.Data.Migrations
{
    ...
    [Migration("20190825111608_FixingSkillTable")]
    partial class FixingSkillTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apprenticeship.Models.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Apprenticeship.Models.Report", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Apprenticeship.Models.StudentsSkills", b =>
                {
                    b.Property<string>("StudentId");
            ...
            modelBuilder.Entity("Apprenticeship.Models.Comment", b =>
                {
                    b.HasOne("Apprenticeship.Models.Report")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Apprenticeship.Models.Report", b =>
                {
                    b.HasOne("Apprenticeship.Models.Student")
                        .WithMany("Reports")
                        .HasForeignKey("StudentId");
                });
